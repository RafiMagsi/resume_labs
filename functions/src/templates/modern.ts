...
export async function generateModernTemplate(resumeData: ResumeData): Promise<Buffer> {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      addSection(doc, "Professional Summary", primaryColor, softDividerColor, () => {
        const summary = resumeData.personalSummary?.trim() || "No personal summary provided.";
        writeBodyText(doc, summary, textColor);
      });

      addSection(doc, "Work Experience", primaryColor, softDividerColor, () => {
      ...
      addSection(doc, "Skills", primaryColor, softDividerColor, () => {
