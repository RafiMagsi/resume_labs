  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      addSection(doc, "Professional Summary", accentColor, dividerColor, () => {
        const summary = resumeData.personalSummary?.trim() || "Data scientist & AI engineer.";
      ...
      addSection(doc, "Professional Experience", accentColor, dividerColor, () => {
        ...
        resumeData.workExperiences.forEach((exp, index) => {
          writeDataScienceExperience(doc, exp, {
            accentColor,
            darkColor,
            mutedColor,
            textColor,
      ...
      addSection(doc, "Technical Skills", accentColor, dividerColor, () => {
...
function buildHeader(
  ...
  doc
    ...
    .text(resumeData.title?.trim() || "Data Scientist", PAGE_MARGIN, titleY, {
  ...
  doc
    ...
    .text("AI Engineer • ML Specialist • Analytics", PAGE_MARGIN, titleBottomY + 4, {
      width: textColumnWidth,
      align: "left",
    });
...
function drawPhotoPlaceholder(
  ...
  doc
    ...
    .fillAndStroke("#E0F2FE", borderColor)
    .restore();
...
function writeDataScienceExperience(
  doc: PDFKit.PDFDocument,
